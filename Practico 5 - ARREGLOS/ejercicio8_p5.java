...
public class ejercicio8_p5{
    ...
    public static void corrimientoIzquierda(int[]arr, int numusuario){
        for(int pos = numusuario; pos < MAX-1; pos++){
            arr[pos] = arr[pos+1];
        }
    }
